...
# Trading Mode
MARGIN_CROSS = "cross" # 全倉
MARGIN_ISOLATED = "isolated" # 逐倉
NO_MARGIN_CASH = "cash" # 非保證金
NO_MARGIN_LEAD_TRADING = "spot_isolated" # 現貨逐倉(僅適用現貨帶單)

# Position Mode
POSITION_MODE_LONG_SHORT = "long_short_mode" # 開平倉模式
POSITION_MODE_NET = "net_mode" # 買賣模式
